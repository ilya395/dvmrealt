...
function PageLoad() {
	...
	setTimeout(function () {
		...
		TweenMax.to($('.hold-progress-bar'), 1, {
			force3D: true,
			width: '100%',
			delay: 1,
			ease: Power2.easeOut,
			onComplete: function () { //modified time
				...
				$('body').waitForImages({
					finished: function () {
						...
						setTimeout(function () {
							...
							$('body').waitForImages({
								finished: function () {
									TweenMax.to($("#header-container, .header-middle, #footer-container"), 1, {
										force3D: true,
										opacity: 1,
										delay: 0,
										ease: Power2.easeOut
							...
							TweenMax.set($('.stroked .swiper-pagination-bullet-active').prev().find('.title'), {
								opacity: 0,
								y: -120
							});
							TweenMax.set($('.no-stroked .swiper-pagination-bullet-active').find('.title'), {
								opacity: 0,
								y: 60
							});
							TweenMax.set($('.stroked .swiper-pagination-bullet-active').find('.title'), {
								opacity: 0,
								y: 60
							});
							TweenMax.set($('.stroked .swiper-pagination-bullet-active').next().find('.title'), {
								opacity: 0,
								y: 240
							});
							...
							TweenMax.to($('.stroked .swiper-pagination-bullet-active').prev().find('.title'), 0.5, {
								force3D: true,
								opacity: 0.3,
								y: -slidertitleheight,
								delay: 0.8,
							...
							TweenMax.to($('.no-stroked .swiper-pagination-bullet-active').find('.title'), 0.5, {
								force3D: true,
								opacity: 1,
								y: 0,
								delay: 0.9,
							...
							TweenMax.to($('.stroked .swiper-pagination-bullet-active').find('.title'), 0.5, {
								force3D: true,
								opacity: 0.3,
								y: 0,
								delay: 0.9,
							...
							TweenMax.to($('.stroked .swiper-pagination-bullet-active').next().find('.title'), 0.5, {
								force3D: true,
								opacity: 0.3,
								y: slidertitleheight,
								delay: 1,
							...
							TweenMax.set($('.swiper-slide-active').find('.title'), {
								y: slidertitleheight
							});
							TweenMax.set($('.swiper-slide-active').find('.subtitle'), {
								y: 40
							});
							...
							tlCarousel.set($("#showcase-carousel .swiper-slide"), {
								x: 300,
								opacity: 0
							});
...
function FirstLoad() {
	...
	$('a.ajax-link').on('click', function () {
		...
		if ($('#showcase-holder').length > 0) {
			TweenMax.to($(".swiper-pagination-bullet .title"), 0.4, {
				force3D: true,
				opacity: 0,
				ease: Power2.easeOut
			});
	...
	$('#showcase-slider a.title').on('click', function () {
		...
		TweenMax.to($(".showcase-captions-wrap.stroked, .header-middle, .title span"), 0.3, {
			force3D: true,
			opacity: 0,
			delay: 0,
			ease: Power2.easeOut
	...
	$('.next-ajax-link-project').on('click', function () {
		...
		TweenMax.to($(".next-subtitle-info"), 0.3, {
			force3D: true,
			opacity: 0,
			delay: 0,
			ease: Power2.easeOut
		});
		TweenMax.to($(".next-subtitle-name"), 0.3, {
			force3D: true,
			opacity: 1,
			y: 0,
			delay: 0.3,
	...
	var captionParallax = TweenMax.to('.has-image #hero-caption', 0.5, {
		top: "25%",
		ease: Linear.easeNone
	});
	var bottomParallax = TweenMax.to('.has-image .hero-bottom', 0.5, {
		opacity: "0",
		ease: Linear.easeNone
	});
	...
	$('.quickmenu, #close-quickmenu').on('click', function () {
		...
		setTimeout(function () {
			if ($('#quickmenu').hasClass("active")) {
				...
				$('#quickmenu-scroll').animate({
					scrollTop: $('#quickmenu').offset().top
				}, 0);

				TweenMax.to($("#showcase-holder"), 0.5, {
					force3D: true,
					opacity: 0,
					delay: 0.3,
					ease: Power2.easeInOut
				...
				TweenMax.to($("#footer-container"), 0.3, {
					force3D: true,
					opacity: 0,
					delay: 0.4,
					ease: Power2.easeOut
				...
				quicktitle.set($(".q-timeline"), {
					opacity: 0,
					y: 60
				});
				$(".q-timeline").each(function (index, element) {
					quicktitle.to(element, 0.5, {
						opacity: 1,
						y: 0,
						delay: 0.5,
						ease: Power3.easeOut
				...
				TweenMax.to($("#footer-container"), 0.5, {
					force3D: true,
					opacity: 1,
					delay: 1,
					ease: Power2.easeOut
				...
				TweenMax.to($("#showcase-holder"), 0.6, {
					force3D: true,
					scale: 1,
					opacity: 1,
					delay: 0.3,
		...
		var swiperOptions = {
			...
			on: {
				...
				slideChangeTransitionStart: function () {
					...
					TweenMax.to($('.no-stroked .swiper-pagination-bullet-active').prev().find('.title'), 0.6, {
						y: -slidertitleheight,
						opacity: 1,
						ease: Power1.easeInOut
					})
					TweenMax.to($('.no-stroked .swiper-pagination-bullet-active').find('.title'), 0.6, {
						y: 0,
						opacity: 1,
						delay: 0,
						ease: Power1.easeInOut
					})
					TweenMax.to($('.no-stroked .swiper-pagination-bullet-active').next().find('.title'), 0.6, {
						y: slidertitleheight,
						opacity: 1,
						ease: Power1.easeInOut
					})
					...
					TweenMax.to($('.stroked .swiper-pagination-bullet-active').prev().find('.title'), 0.6, {
						y: -slidertitleheight,
						opacity: 0.3,
						ease: Power1.easeInOut
					})
					TweenMax.to($('.stroked .swiper-pagination-bullet-active').prev().prev().find('.title'), 0.6, {
						y: -slidertitleheight * 2,
						opacity: 0.3,
						ease: Power1.easeInOut
					})

					TweenMax.to($('.stroked .swiper-pagination-bullet-active').find('.title'), 0.6, {
						y: 0,
						opacity: 0.3,
						delay: 0,
						ease: Power1.easeInOut
					...
					TweenMax.to($('.stroked .swiper-pagination-bullet-active').next().find('.title'), 0.6, {
						y: slidertitleheight,
						opacity: 0.3,
						ease: Power1.easeInOut
					})
					TweenMax.to($('.stroked .swiper-pagination-bullet-active').next().next().find('.title'), 0.6, {
						y: slidertitleheight * 2,
						opacity: 0.3,
						ease: Power1.easeInOut
					})

					TweenMax.to($('.showcase-subtitles-wrap .swiper-pagination-bullet-active').prev().find('.subtitle'), 0.6, {
						y: -20,
						opacity: 1,
						ease: Power1.easeInOut
					})
					TweenMax.to($('.showcase-subtitles-wrap .swiper-pagination-bullet-active').find('.subtitle'), 0.6, {
						y: 0,
						opacity: 1,
						delay: 0,
						ease: Power1.easeInOut
					})
					TweenMax.to($('.showcase-subtitles-wrap .swiper-pagination-bullet-active').next().find('.subtitle'), 0.6, {
						y: 20,
						opacity: 1,
						ease: Power1.easeInOut
					})
	...
	if ($('#showcase-carousel-slider').length > 0) {
			...
			var swiperOptions = {
				...
				on: {
					...
					slideChangeTransitionStart: function () {
						...
						TweenMax.to($('.swiper-slide-active').prev().find('.title'), 0.4, {
							y: -slidertitleheight,
							opacity: 1,
							ease: Power1.easeInOut
						})
						...
						TweenMax.to($('.swiper-slide-active').next().find('.title'), 0.4, {
							y: slidertitleheight,
							opacity: 1,
							ease: Power1.easeInOut
						})

						TweenMax.to($('.swiper-slide-active').prev().find('.subtitle'), 0.4, {
							y: -40,
							opacity: 1,
							ease: Power1.easeInOut
						})
						...
						TweenMax.to($('.swiper-slide-active').next().find('.subtitle'), 0.4, {
							y: 40,
							opacity: 1,
							ease: Power1.easeInOut
						})
		...
		if ($(window).width() >= 1024) {
			...
			$('#showcase-holder').on('mousedown', function (event) {
				...
				TweenMax.to('#hold-event', 0.6, {
					scale: 0
				});
				var progress = $('#hold-event');
				TweenMax.to(progress, 0.6, {
					force3D: true,
					...
					onComplete: function () {
						...
						TweenMax.to('#showcase-holder-wrap', 1, {
							scale: 0.7,
							ease: Power4.easeOut
						});
						...
						TweenMax.to($('.swiper-slide').find('.title'), 0, {
							y: 0,
							opacity: 1,
							delay: 0,
							ease: Power1.easeInOut
						})
						TweenMax.to($('.swiper-slide').find('.subtitle'), 0.4, {
							y: 40,
							opacity: 1,
							delay: 0,
							ease: Power1.easeInOut
			...
			$('#showcase-holder').on('mouseup', function (event) {
				...
				TweenMax.to('#showcase-holder-wrap', 0.4, {
					scale: 1,
					delay: 0.5
				});
				TweenMax.to('#ball', 0.2, {
				...
				TweenMax.to($('.swiper-slide-active').find('.subtitle'), 0.5, {
					y: 0,
					opacity: 1,
					delay: 0.1,
					ease: Power1.easeInOut
		...
		$('#main-page-content.portfolio-page').on('mousedown', function (event) {
			...
			TweenMax.to(progress, 1, {
				...
				onComplete: function () {
					...
					TweenMax.to($(".below-caption .item-caption"), 0.5, {
						opacity: 0,
						delay: 0.2,
						ease: Power2.easeOut
					});
					...
					//Fade In Navigation Lists
					TweenMax.set($(".filters-info"), {
						y: 30,
						opacity: 0
					});
					TweenMax.to($(".filters-info"), 0.4, {
						force3D: true,
						y: 0,
						opacity: 1,
						delay: 0.7,
		...
		$('#show-filters, #close-filters').on('click', function () {
			...
			setTimeout(function () {
				if ($('#filters-overlay').hasClass("active")) {
					...
					TweenMax.to($(".below-caption .item-caption"), 0.3, {
						opacity: 0,
						ease: Power2.easeOut
					});
...
function Sliders() {
	...
	$(".owl-prev").mouseenter(function (e) {
		...
		$("#ball").addClass("with-icon").append('<i class="fa fa-chevron-left fa-2x"></i>');
	});
	...
	$(".owl-next").mouseenter(function (e) {
		...
		$("#ball").addClass("with-icon").append('<i class="fa fa-chevron-right fa-2x"></i>');
	});
	...
	if ($('.text-carousel').length > 0) {
		$(".text-carousel").owlCarousel({
			...
			nav: true,
			navText: ["<div class='prev-testimonial parallax-element'><i class='fa fa-chevron-left fa-2x' aria-hidden='true'></i></div>", "<div class='next-testimonial parallax-element'><i class='fa fa-chevron-right fa-2x' aria-hidden='true'></i></div>"],
		});
	}
...
function Lightbox() {
	...
	$(".image-link").mouseenter(function (e) {
		...
		$("#ball").addClass("with-icon").append('<i class="fa fa-plus fa-2x"></i>');
	});
