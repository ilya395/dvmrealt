					...
					<div id="header-container">
						...
						<div id="logo" class="hide-ball">
							<a class="ajax-link" data-type="page-transition" href="<?php echo home_url(); ?>">
								<img class="black-logo" src="wp-content/themes/dvmrealt/assets/images/svg/logo.svg" alt="Logo">
								<img class="white-logo" src="wp-content/themes/dvmrealt/assets/images/svg/logo.svg" alt="Logo">
							</a>
						</div>
						<!--/Logo -->
									...
									<!-- <div class="inner">
										<ul data-breakpoint="10025" class="flexnav">
											<li class="link menu-timeline">
												<a class="active" href="main.html"><span data-hover="Проекты">Проекты</span>
												</a>
											</li>
											<li class="link menu-timeline">
												<a class="ajax-link" data-type="page-transition" href="/contact.html"><span data-hover="Contact">Контакты</span>
												</a>
											</li>
										</ul>
									</div> -->
					...
					<div id="main">
							...
							<div id="hero-styles" class="parallax-onscroll">
								<div id="hero-caption">
									<div class="inner hello-page">
										<img class="mb-50 desktop" src="wp-content/themes/dvmrealt/assets/images/svg/logo.svg" style="height: 5rem; margin: 0 auto 50px;" alt="">
										<h4 class="hello-page">Квартиры в&nbsp;Жилых комплексах Казани по&nbsp;ценам застройщика </h4>
										<h4 class="hello-sub pt-20">Квартиры от 2.5 млн рублей</h4>
						...
						<div id="hero-bg-wrapper">
							<div id="hero-image-parallax">
								<div class="hero-bg-image" style="background-image:url('wp-content/themes/dvmrealt/assets/images/main.png')"></div>
							</div>
						</div>
						<!--/Hero Section -->
					</div>
